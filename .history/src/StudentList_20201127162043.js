    ...
    //     )
        ...
        render() {
            ...
            return(
                ...
                {this.state.filteredStudents.map(student => <li> {student.pic} {student.firstName} {student.lastName} <br></br> Email: {student.email} <br></br>Company: {student.company} <br></br>Skill: {student.skill} <br></br> </li>)}
                </div>        
            )}}