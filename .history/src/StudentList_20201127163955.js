    ...
    //     )
        ...
        // })
            ...
            return(
                ...
                <input type="text" value ={this.state.inputValue} onChange={this.handleNameChange} inputValue={this.state.inputValue} />
                {this.state.students.map(student => <li> {student.pic} {student.firstName} {student.lastName} <br></br> Email: {student.email} <br></br>Company: {student.company} <br></br>Skill: {student.skill} <br></br><br></br> </li>)}
                </div>     
