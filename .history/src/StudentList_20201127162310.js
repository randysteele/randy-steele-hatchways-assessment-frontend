...
state = {
    ...
    //     )
        ...
        render() {
            ...
            return student.firstName.toLowerCase().includes(this.state.inputValue.toLowerCase())
        })
    
            return(
                <div>
                <label htmlFor="search">Search by name</label>
                <input type="text" value ={this.state.inputValue} onChange={this.handleNameChange}/>
                {this.state.students.map(student => <li> {student.pic} {student.firstName.toLowerCase().includes(this.state.inputValue.toLowerCase())} {student.lastName.toLowerCase().includes(this.state.inputValue.toLowerCase())} <br></br> Email: {student.email} <br></br>Company: {student.company} <br></br>Skill: {student.skill} <br></br> </li>)}
                </div>     
