    ...
    //     )
        ...
        render() {
            ...
            return(
                ...
                {this.state.students.map(student => <li> {student.pic} {student.firstName.filteredStudents} {student.lastName} <br></br> Email: {student.email} <br></br>Company: {student.company} <br></br>Skill: {student.skill} <br></br> </li>)}
                </div>     
